...
x_near_1, y_near_1, gap_near_1 = get_points(x_L, y_L, 10, gap_min_x_1,
                                            gap_min_y_1, data=gap_L)
x_near_2, y_near_2, gap_near_2 = get_points(x_L, y_L, 10, gap_min_x_2,
                                            gap_min_y_2, data=gap_L)

minima_lim = 10

popt_1, _ = curve_fit(harmonic_osc, np.column_stack((x_near_1, y_near_1)), gap_near_1,
                      p0=[0.1, gap_min_x_1, gap_min_y_1, np.nanmin(gap)],
                      bounds=([0, gap_min_x_1-minima_lim, gap_min_y_1-minima_lim, -np.inf],
                              [np.inf, gap_min_x_1+minima_lim, gap_min_y_1+minima_lim, np.inf]))

popt_2, _ = curve_fit(harmonic_osc, np.column_stack((x_near_2, y_near_2)), gap_near_2,
                      p0=[0.1, gap_min_x_2, gap_min_y_2, np.nanmin(gap)],
                      bounds=([0, gap_min_x_2-minima_lim, gap_min_y_2-minima_lim, -np.inf],
...
popt_c, _ = curve_fit(harmonic_osc, np.column_stack((x_near, y_near)), gap_c_near,
                      p0=[0.1, gap_c_min_x, gap_c_min_y, np.nanmin(gap_c)],
                      bounds=([0, gap_c_min_x-minima_lim, gap_c_min_y-minima_lim, -np.inf],
