...
folders = np.array(["10.42_546", "13.17_114", "17.90_186", "5.09_762",
                    "7.93_942", "10.99_654", "15.18_258", "18.73_906",
                    "6.01_546", "8.61_798", "11.64_438", "16.43_294",
                    "19.65_618", "7.34_366", "9.43_222"])

folder_subset = np.array(["5.09_762", "7.93_942", "8.61_798",
                          "10.99_654", "18.73_906"])
...
for i in folder_subset:
    ...
    contour_plot_fill(top_strain_x, top_strain_y, top_strain*100,
                      ...
                      "Top W layer strain",
                      "RdGy_r",
                      "Strain", strings=[f"Twist angle: {twist_angle}°",
                                         f"Atoms: {natoms}"])

    contour_plot_fill(bottom_strain_x, bottom_strain_y, bottom_strain*100,
                      "bottom_strain_" + i,
    ...
    contour_plot_fill(interlayer_x, interlayer_y, interlayer_dist,
                      "interlayer_distance_" + i,
                      "Interlayer distance",
                      "RdGy_r",
                      "Distance [Å]", strings=[f"Twist angle: {twist_angle}°",
                                               f"Atoms: {natoms}"])
