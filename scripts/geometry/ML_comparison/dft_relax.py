...
calc_params = {
    "random": True,
    "mode": {"name": "pw", "ecut": 500, "dedecut": "estimate", "dtype": "complex64"},
    "xc": "PBE",
    "parallel": {"gpu": True},
    "kpts": {"size": (1, 1, 1), "gamma": True},
    "eigensolver": {"name": "ppcg", "niter": 4, "include_cg": False},
...
opt = BFGS(
    atoms,
    trajectory="relax_DFT_after_mattersim.traj",
    logfile="DFT_after_mattersim.log",
)
opt.run(fmax=0.01)
