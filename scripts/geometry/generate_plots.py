...
def contour_plot_fill(X: np.ndarray, Y: np.ndarray, Z: np.ndarray,
                      ...
                      cbar_limits=None, position=None):
    ...
    if cbar_limits is not None and len(cbar_limits) == 2:
        ...
        contour = ax.tricontourf(X, Y, Z, levels=lvl,
...
for structure in [structure]:
    ...
    atoms = read(path_to_structure /
                 str("structures/MoS2-WSe2-MatterSim/"
                     + structure + "/structure_ml.json"))
    ...
    contour_plot_fill(h_distance_x, h_distance_y, h_distance,
                      ...
                      "viridis", "Horizontal distance [Å]", strings=text)
    ...
    Mo_x, Mo_y, Mo_strain = f.repeate_cells(Mo_x, Mo_y, Mo_strain,
    ...
    contour_plot_fill(Mo_x, Mo_y, Mo_strain*100,
    ...
    contour_plot_fill(S_x, S_y, S_thickness,
                      ...
                      "viridis", "Thickness [Å]", strings=text)
    ...
    contour_plot_fill(inter_x, inter_y, inter_distance,
                      ...
                      "viridis", "Distance [Å]", strings=text)
