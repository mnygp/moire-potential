...
data = np.genfromtxt("band_edges_medium.csv",
...
ax1.scatter(Mo_strain * 100, interp_W_strain * 100, marker="x", color="black", label="Values at ")
...
cbar = fig.colorbar(im, ax=ax1, label="Band Gap [eV]")
# ax1.tight_layout()
...
plt.savefig("correction-values.png", dpi=500)
plt.close()
